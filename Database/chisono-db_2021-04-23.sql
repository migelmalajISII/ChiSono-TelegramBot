...
--
-- Host: 127.0.0.1:3306
-- Creato il: Apr 23, 2021 alle 22:48
...
-- Database: `VQu2KRKfj8`
--
CREATE DATABASE IF NOT EXISTS `VQu2KRKfj8` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `VQu2KRKfj8`;
...
--
-- Creazione: Apr 23, 2021 alle 21:16
--
...
--
-- RELAZIONI PER TABELLA `categorie`:
--
...
INSERT DELAYED INTO `categorie` (`IDCategoria`, `Alias`) VALUES
(2, 'Animali e Insetti'),
(3, 'Citta'),
(4, 'Persone'),
(1, 'Random');
...
--
-- RELAZIONI PER TABELLA `elementi`:
--   `FKCategoria`
...
INSERT DELAYED INTO `elementi` (`IDElemento`, `Valore`, `Link`, `FKCategoria`) VALUES
...
--
-- Struttura della tabella `logpartite`
--
-- Creazione: Apr 23, 2021 alle 21:16
--

CREATE TABLE `logpartite` (
  `FKUtente` int NOT NULL,
  `FKPartita` int NOT NULL,
  `FKElemento` int DEFAULT NULL,
  `Classificato` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- RELAZIONI PER TABELLA `logpartite`:
--   `FKUtente`
--       `utenti` -> `IDUtente`
--   `FKPartita`
--       `partite` -> `IDPartita`
...
CREATE TABLE `partite` (
  ...
  `FKCategoria` int NOT NULL DEFAULT '1',
  `FKGruppo` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- RELAZIONI PER TABELLA `partite`:
--   `FKCategoria`
--       `categorie` -> `IDCategoria`
--   `FKGruppo`
--       `utenti` -> `IDUtente`
...
--
-- Indici per le tabelle `logpartite`
--
ALTER TABLE `logpartite`
  ADD PRIMARY KEY (`FKUtente`,`FKPartita`),
  ADD KEY `FKPartite` (`FKPartita`),
...
--
ALTER TABLE `elementi`
  MODIFY `IDElemento` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT per la tabella `partite`
--
ALTER TABLE `partite`
  MODIFY `IDPartita` int NOT NULL AUTO_INCREMENT;
...
--
-- Limiti per la tabella `logpartite`
--
ALTER TABLE `logpartite`
  ADD CONSTRAINT `logpartite_ibfk_1` FOREIGN KEY (`FKUtente`) REFERENCES `utenti` (`IDUtente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `logpartite_ibfk_2` FOREIGN KEY (`FKPartita`) REFERENCES `partite` (`IDPartita`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `logpartite_ibfk_3` FOREIGN KEY (`FKElemento`) REFERENCES `elementi` (`IDElemento`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limiti per la tabella `partite`
--
ALTER TABLE `partite`
  ADD CONSTRAINT `partite_ibfk_1` FOREIGN KEY (`FKCategoria`) REFERENCES `categorie` (`IDCategoria`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `partite_ibfk_2` FOREIGN KEY (`FKGruppo`) REFERENCES `utenti` (`IDUtente`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
